  ...
  return (
    <>
      <div className={style.vacancy}>
        ...
        <div className={style.vacancy__header}>
          <div className={style.vacancy__header__leftSide}>
            <ul className={style.vacancy__header__leftSide__list}>
              <li
                className={style.vacancy__header__leftSide__item}
              >{`Опыт работы от: ${experience}`}</li>
              <li
                className={style.vacancy__header__leftSide__item}
              >{`з/п: ${salary}`}</li>
        ...
        <div className={style.vacancy__footer}>
          {!isOpen && (
            <Button
              title={"Подробнее"}
              color="#3D69B7"
          ...
          <div className={style.vacancy__footer__display}>
            <Button
              title="Откликнуться"
              color="#3D69B7"
              border="1px solid #3D69B7"
